...
//		outputStream.write("HTTP/".getBytes("UTF-8"));
		outputStream.write((protocol + " 404 File Not Found").getBytes("UTF-8"));
		outputStream.write("Content-Type:text/html; charset=utf-8".getBytes("UTF-8"));
		outputStream.write("\r\n".getBytes("UTF-8"));
		outputStream.write(body);
		
		
		// HTTP/1.1 404 File Nou Found
	...
	public void response400Error(OutputStream outputStream, String url) throws IOException {
